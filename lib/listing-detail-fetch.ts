...
export const LISTING_SELLER_EMBED =
  "users!fk_listings_seller(id,display_name,avatar_url,trust_badge,dl_verified,ein_verified,ine_verified,rfc_verified,phone_verified,whatsapp_optin,created_at,facebook_url,instagram_handle)";
