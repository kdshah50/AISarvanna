...
export const MARKETPLACE_CATEGORIES: MarketplaceCategory[] = [
  ...
  },
  {
    id: "wedding_photo",
    icon: "📸",
    label: { es: "Fotografía / video de bodas", en: "Wedding photo & video", hi: "शादी फोटो / वीडियो" },
    browseEnabled: true,
    serviceVertical: true,
    communityLanes: ["south_asian"],
  },
  {
    id: "dj_music",
    icon: "🎧",
    label: { es: "DJ y música para fiestas", en: "DJ & event music", hi: "DJ और इवेंट संगीत" },
    browseEnabled: true,
    serviceVertical: true,
    communityLanes: ["south_asian"],
  },
  {
    id: "saree_lehenga",
    icon: "👘",
    label: { es: "Saree y lehenga", en: "Saree & lehenga", hi: "साड़ी और लहंगा" },
    browseEnabled: true,
    communityLanes: ["south_asian"],
  },
  {
    id: "puja_items",
    icon: "🪔",
    label: { es: "Artículos de puja", en: "Puja & prayer items", hi: "पूजा सामग्री" },
    browseEnabled: true,
    communityLanes: ["south_asian"],
  },
  {
    id: "catering",
    icon: "🍽️",
    label: { es: "Catering", en: "Catering", hi: "केटरिंग" },
    browseEnabled: true,
    serviceVertical: true,
    communityLanes: ["south_asian"],
  },
  {
    id: "home_improvement",
    icon: "🏗️",
    label: { es: "Mejoras del hogar", en: "Home improvement", hi: "घर की मरम्मत" },
    browseEnabled: true,
    serviceVertical: true,
    communityLanes: ["south_asian"],
  },
