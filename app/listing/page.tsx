...
export default async function HomePage({ searchParams }: Props) {
  ...
  try {
    let url = `${SUPA_URL}/rest/v1/listings?select=id,title_es,price_mxn,category_id,condition,location_city,shipping_available,negotiable,photo_urls,users(display_name,trust_badge,ine_verified)&status=eq.active&category_id=eq.services&order=created_at.desc&limit=24`;
