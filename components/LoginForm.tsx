        ...
        <div className="bg-white rounded-2xl border border-[#E5E0D8] p-8 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" disabled={loading}
              ...
              {loading ? <><div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" /> Enviando...</> : <>
          ...
          <p className="text-xs text-[#9CA3AF] text-center mt-4">Al continuar aceptas nuestros <span className="text-[#1B4332]">Términos de uso</span>.</p>
        </div>
      </div>
    </main>
  );
