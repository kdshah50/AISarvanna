...
LABEL_CATEGORY_MAP: list[tuple[str, TianguisCategory]] = [
    ...
    # South Asian & events — listed before generic fashion / home so specific labels win.
    ("henna", TianguisCategory.MEHNDI),
    ("mehndi", TianguisCategory.MEHNDI),
    ("mehandi", TianguisCategory.MEHNDI),
    ("tiffin", TianguisCategory.TIFFIN),
    ("wedding photo", TianguisCategory.WEDDING_PHOTO),
    ("bride", TianguisCategory.WEDDING_PHOTO),
    ("groom", TianguisCategory.WEDDING_PHOTO),
    ("wedding", TianguisCategory.WEDDING_PHOTO),
    ("dj", TianguisCategory.DJ_MUSIC),
    ("disc jockey", TianguisCategory.DJ_MUSIC),
    ("saree", TianguisCategory.SAREE_LEHENGA),
    ("sari", TianguisCategory.SAREE_LEHENGA),
    ("lehenga", TianguisCategory.SAREE_LEHENGA),
    ("kurta", TianguisCategory.SAREE_LEHENGA),
    ("incense", TianguisCategory.PUJA_ITEMS),
    ("deity", TianguisCategory.PUJA_ITEMS),
    ("idol", TianguisCategory.PUJA_ITEMS),
    ("altar", TianguisCategory.PUJA_ITEMS),
    ("catering", TianguisCategory.CATERING),
    ("buffet", TianguisCategory.CATERING),
    ("renovation", TianguisCategory.HOME_IMPROVEMENT),
    ("flooring", TianguisCategory.HOME_IMPROVEMENT),
    ("tile", TianguisCategory.HOME_IMPROVEMENT),
